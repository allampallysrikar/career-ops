...
<p align="center">
  <a href="https://x.com/allampallysrikar"><img src="docs/hero-banner.jpg" alt="Career-Ops — 多代理求職系統" width="800"></a>
</p>
...
這個系統由一位親身使用它評估超過 740 份職缺、生成超過 100 份客製化履歷、並成功獲得 Head of Applied AI 職位的人所打造。[閱讀完整案例研究](https://github.com/allampallysrikar/career-ops-system)。
...
使用 career-ops 找到工作了嗎？[分享你的故事！](https://github.com/allampallysrikar/career-ops/issues/new?template=i-got-hired.yml)
