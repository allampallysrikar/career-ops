...
import (
	...
	"github.com/allampallysrikar/jobforge/dashboard/internal/data"
	"github.com/allampallysrikar/jobforge/dashboard/internal/model"
	"github.com/allampallysrikar/jobforge/dashboard/internal/theme"
)
...
func (m PipelineModel) renderHelp() string {
	...
	brand := lipgloss.NewStyle().Foreground(m.theme.Overlay).Render("JobForge by Srikar Allampally")
