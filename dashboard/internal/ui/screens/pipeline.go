...
import (
	...
	"github.com/allampallysrikar/career-ops/dashboard/internal/data"
	"github.com/allampallysrikar/career-ops/dashboard/internal/model"
	"github.com/allampallysrikar/career-ops/dashboard/internal/theme"
)
...
func (m PipelineModel) renderHelp() string {
	...
	brand := lipgloss.NewStyle().Foreground(m.theme.Overlay).Render("career-ops by Srikar Allampally")
