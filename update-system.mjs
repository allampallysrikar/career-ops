...
const CANONICAL_REPO = 'https://github.com/allampallysrikar/career-ops.git';
const RAW_VERSION_URL = 'https://raw.githubusercontent.com/allampallysrikar/career-ops/main/VERSION';
const RELEASES_API = 'https://api.github.com/repos/allampallysrikar/career-ops/releases/latest';
...
async function apply() {
  ...
  try {
    ...
    // See: https://github.com/allampallysrikar/career-ops/issues/649
