...
/**
 * update-system.mjs — Safe auto-updater for JobForge
 *
...
const CANONICAL_REPO = 'https://github.com/allampallysrikar/jobforge.git';
const RAW_VERSION_URL = 'https://raw.githubusercontent.com/allampallysrikar/jobforge/main/VERSION';
const RELEASES_API = 'https://api.github.com/repos/allampallysrikar/jobforge/releases/latest';
    ...
    [versionResult, releaseResult] = await Promise.allSettled([
      ...
      fetch(RELEASES_API, {
        headers: {
          ...
          'User-Agent': 'JobForge-update-checker',
        },
...
async function apply() {
  ...
  try {
    ...
    // See: https://github.com/allampallysrikar/jobforge/issues/649
