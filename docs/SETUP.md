...
| Search for offers | `/JobForge scan` |
| Process pending URLs | `/JobForge pipeline` |
| Generate a PDF | `/JobForge pdf` |
| Batch evaluate | `/JobForge batch` |
| Check tracker status | `/JobForge tracker` |
| Fill application form | `/JobForge apply` |
