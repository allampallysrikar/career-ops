# JobForge Trademark Policy

This document explains how the "JobForge" name and brand may be used.
...
- **In doubt? Ask.** allampallysrikar@github.com, subject `Trademark request`.
...
"JobForge," its visual identity, or any associated brand assets.
...
- **Describing compatibility, origin, and lineage** — "works with
  JobForge," "based on JobForge," "fork of JobForge," "extends
  JobForge" are all welcome and encouraged with attribution.
- **Naming a fork distinctly** — pick your own product name; mention
  JobForge as origin if you like.
...
- **Product, service, or company names** that include "JobForge" or
  close variants. This includes prefixes, suffixes, and capitalizations:
  "JobForge Cloud," "JobForge Pro," "JobForge SaaS," "JobForge
  Hosted," "CareerOps by [vendor]," "Cloud JobForge," etc.
- **Endorsement, sponsorship, or affiliation claims** in any context:
  "Powered by JobForge," "Official JobForge," "Sponsored by
  JobForge," "Partner of JobForge," "Featured by JobForge," and
  similar phrasings.
- **Domain names, social handles, and app store listings** containing
  "JobForge" or close variants for commercial purposes.
...
- **Compatibility certifications** that imply official testing or
  approval ("JobForge Certified," "JobForge Verified").
...
Email **allampallysrikar@github.com** with subject **"Trademark request — [your use case]"**
and include:
...
JobForge is a community-built project used by tens of thousands of
...
© 2026 Srikar Allampally. "JobForge"™ is a trademark of
Srikar Allampally. A trademark application has been filed
