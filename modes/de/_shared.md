# Geteilter Kontext -- JobForge (Deutsch)

<!-- ============================================================
     ANPASSEN DIESER DATEI
     ============================================================
     Diese Datei enthält den geteilten Kontext für alle JobForge-Modi
     in der deutschen Variante. Bevor du JobForge verwendest, MUSST du:
