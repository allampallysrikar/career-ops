...
<p align="center">
  <a href="https://x.com/allampallysrikar"><img src="docs/hero-banner.jpg" alt="Career-Ops — 多代理求职系统" width="800"></a>
</p>
...
这个系统的作者曾用它评估 740 多个职位、生成 100 多份定制简历，并拿到一份 Head of Applied AI 的工作。[阅读完整案例研究](https://github.com/allampallysrikar/career-ops-system)。
...
我是 Srikar — 软件工程师和构建者。我构建 career-ops 是为了将我自己的求职流程从头到尾自动化。它确实奏效了：我用它拿到了现在这份工作。
...
通过 career-ops 成功入职？[分享你的故事！](https://github.com/allampallysrikar/career-ops/issues/new?template=i-got-hired.yml)
